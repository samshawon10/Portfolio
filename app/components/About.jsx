    ...
    return(
        ...
        >
            ...
            className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am an experienced Frondend Developer with over a decade of professional expertise in the field. Throughtout my career, I have had the privilege of collaborating with prsestigious oragranization, contributing to their success and growth.
                    </p>

...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
    ...
    return (
        ...
        flex justify-between items-center z-50 ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm dark:bg-darkTheme  dark:shadow-white/20 ":""} `}>
            <a href="#top">
...
<button onClick={()=> setIsDarkMode(prev => !prev)} >
    <Image src={isDarkMode ?assets.sun_icon : assets.moon_icon} alt='' className='w-6' />
                ...
                <a href="#contact" className='hidden items-center lg:flex  gap-3 px-10
                ...
                <button className='block md:hidden ml-3 items-center  '>
